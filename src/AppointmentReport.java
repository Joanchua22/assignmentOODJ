...
public class AppointmentReport extends javax.swing.JFrame {
    ...
    public AppointmentReport(String currentUserId) {
        ...
        public void mouseClicked(java.awt.event.MouseEvent evt) {
            if (evt.getClickCount() == 2) {
                ...
                showAppointmentDetailsPopup(appointmentId);
            }
        }
    });
    }
    ...
    private void showReportPreviewPopup() {
        ...
        String reportText = generateAppointmentReportText();

        JDialog dialog = new JDialog(this, "Appointment Report Preview", true);
    ...
    private void exportAppointmentPopup() {
        String reportText = generateAppointmentReportText();
        ...
        fileChooser.setDialogTitle("Export Appointment Report");
        fileChooser.setSelectedFile(new java.io.File("Appointment_Report.txt"));
    ...
    private String generateAppointmentReportText() {
        StringBuilder sb = new StringBuilder();

        sb.append("APU Automotive Service Centre\n");
        sb.append("Appointment Report\n");
        sb.append("Generated By: ").append(currentUserId).append("\n");
        sb.append("Generated At: ").append(FileManager.getCurrentDateTime()).append("\n");
        sb.append("==============================================================\n\n");

        sb.append(String.format("%-15s %-12s %-12s %-12s %-12s %-20s\n",
        ...
        sb.append("\n==============================================================\n");
        sb.append("Appointment Summary\n");
        sb.append("Total Appointment: ").append(totalAppointmentField.getText()).append("\n");
        sb.append("Assigned: ").append(assignedField.getText()).append("\n");
        sb.append("Completed: ").append(completedField.getText()).append("\n");
        sb.append("Cancelled: ").append(cancelledField.getText()).append("\n");

        return sb.toString();
    }
    
    private void showAppointmentDetailsPopup(String appointmentId) {
        try {
            String[] details = FileManager.getAppointmentDetailsById(appointmentId);
            ...
            dialog.setFont(new Font("Monospaced", Font.PLAIN, 12));
            ...
            panel.add(new JLabel(appointmentId));
            ...
            panel.add(new JLabel("Counter Staff:"));
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(statusComboBox, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(technicianField, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE))))
