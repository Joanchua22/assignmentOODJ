...
public class LeaveComment extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(LeaveComment.class.getName());
    
    private String currentUserId;
    private List<String[]> appointmentDetails = new ArrayList<>();

    public LeaveComment(String currentUserId) {
            ...
            try {
                ...
                if (option == 1) {
                    ...
                    if (submitted) {
                        ...
                        FileManager.addActivityLog(currentUserId, "Leave Comment", "Submitted comment for " + vehicle + " (" + serviceName + ")");
                        loadAppointmentTable();
                    } else {
