...
public class TechnicianPage extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(TechnicianPage.class.getName());

    private String currentUserId;
    public TechnicianPage(String currentUserId) {        
